...
export default function CTASection({
  ...
  switch (variant) {
    case 'gradient':
      containerClasses += " bg-gradient-to-br from-background via-primary/10 to-background";
      break;
    case 'border':
      containerClasses += " border border-border/40 rounded-3xl dark-card";
      break;
    default:
      containerClasses += " bg-gradient-to-b from-background/95 via-background to-background/95";
      break;
  }
  ...
  return (
    <section className={`${containerClasses} ${className}`}>
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[120%] h-[1px] bg-gradient-to-r from-transparent via-primary/30 to-transparent" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[120%] h-[1px] bg-gradient-to-r from-transparent via-primary/30 to-transparent" />
